...
export const accordionData = [
    {
      ...
      content: `Your school will give you a code to register an account to OUAC. You can expect it by the end of November, but usually between late October to early November.
      `
    },
    {
      title: 'How many programs should I apply to? ',
      content: `If you are confident about the field/program you want to enter, 4-5 is optimal - 2 reaches, 2 target, and a safety. 
      If you are not sure about your path, you may need to apply to more to keep your options open. `
    },
    {
      title: 'Do rankings matter?',
      content: `It depends on your field. Rankings are often based on graduate research output and may be useful for entry to graduate/professional programs like medicine or law.
      For other sciences, arts, or engineering, prioritize programs with a good co-op system (such as Waterloo). `
    },
    {
