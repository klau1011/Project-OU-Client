...
function Grid() {
  ...
  const gridItems = [
...

    {
      ...
      image: 'https://cdn.discordapp.com/attachments/715319623637270638/959935257329696808/unknown.png',
    ...
    },
    {
      ...
      image: 'https://media.discordapp.net/attachments/832303072645742632/994397194536898560/unknown.png',
      title: 'Senior 101',
    ...
    },
    {
      ...
      path: '/FAQ',
      className: 'FAQ',
      image: 'https://media.discordapp.net/attachments/832303072645742632/994397941970243614/unknown.png',
      title: 'FAQ',
